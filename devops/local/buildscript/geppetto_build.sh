...
APPLICATION='/newgeppettoapplicationdemo005'
...
DESKTOPIMAGENAME='geppettotest/newgeppettoapplicationdemo005-desktop:1.0'
...
helm install --name newgeppettoapplicationdemo005-5259 ./helm
if [ $? -eq 0 ]; then
